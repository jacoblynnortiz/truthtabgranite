...
let scheduleRow1 = document.createElement("tr");
let scheduleRow2 = document.createElement("tr");
let scheduleRow3 = document.createElement("tr");

scheduleRow1.classList.add('table-row');
scheduleRow2.classList.add('table-row');
scheduleRow3.classList.add('table-row');
...
scheduleRow1.appendChild(M1date);
scheduleRow1.appendChild(M1door1);
scheduleRow1.appendChild(M1door2);
scheduleRow1.appendChild(M1door3);
scheduleRow1.appendChild(M1usher);
monthTable1.appendChild(scheduleRow1);

scheduleRow2.appendChild(M2date);
scheduleRow2.appendChild(M2door1);
scheduleRow2.appendChild(M2door2);
scheduleRow2.appendChild(M2door3);
scheduleRow2.appendChild(M2usher);
monthTable2.appendChild(scheduleRow2);

scheduleRow3.appendChild(M3date);
scheduleRow3.appendChild(M3door1);
scheduleRow3.appendChild(M3door2);
scheduleRow3.appendChild(M3door3);
scheduleRow3.appendChild(M3usher);
monthTable3.appendChild(scheduleRow3);
