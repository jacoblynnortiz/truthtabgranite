let forgotPasswordBtn1 = document.getElementById('forgotPasswordBtn1');
let forgotPasswordBtn2 = document.getElementById('forgotPasswordBtn2');

let forgotPasswordContainer = document.getElementById('forgotPasswordContainer');

forgotPasswordBtn1.addEventListener('click', forgotPassword);
forgotPasswordBtn2.addEventListener('click', forgotPassword);

function forgotPassword() {
    forgotPasswordContainer.classList.toggle('enabled');
...
function setupPasswordChange(accountUUID) {
    let resetPasswordContainer1 = document.getElementById('resetPasswordContainer1');
    let resetPasswordContainer2 = document.getElementById('resetPasswordContainer2');
